...
/**
 * Attempt to load the smart-contracts releasePayment at runtime via dynamic require.
 * Returns undefined when the module is not available (e.g. CI without smart-contracts built).
 * Using require() instead of a static import keeps TypeScript's rootDir constraint intact.
 */
